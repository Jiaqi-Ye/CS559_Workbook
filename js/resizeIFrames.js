...
(function() {
    ...
    function hasExplicitHeight(iframe) {
        const h = (iframe.getAttribute("height") || "").trim().toLowerCase();
        return h !== "" && h !== "100%";
    }
    
    function resizeIframe(iframe) {
        // Respect explicitly specified heights from shortcode parameters.
        if (hasExplicitHeight(iframe)) {
            return;
        }
