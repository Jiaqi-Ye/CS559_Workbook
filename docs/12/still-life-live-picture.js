...
/**
 * Capture the main camera's view every frame for a live-updating wall picture.
 */
class LivePictureCapture extends GrObject {
  /**
   * @param {GrWorld} world
  ...
  constructor(world, pictureMaterial) {
    ...
    super("LivePictureCapture", group);
    this.world = world;
  ...
  stepWorld() {
    ...
    // Prevent recursive feedback while capturing.
...
world.add(new LivePictureCapture(world, pictureMaterial));
